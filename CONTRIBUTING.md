# Contributing to NaviXav

Bug reports, reproducible test cases, translations, and design proposals are
welcome through GitHub Issues.

NaviXav uses a dual-licensing model: noncommercial use is offered under the
PolyForm Noncommercial License 1.0.0, while separate commercial licences may
be granted by the copyright holder. A code contribution therefore cannot be
accepted merely under the repository's outbound licence, because that would
...
copyright or grant NaviXav permission to relicense the submitted material.

Do not include third-party code unless its origin and licence are identified
and compatible with both distribution models.

## Français

Les signalements de défauts, cas de test reproductibles, traductions et
propositions de conception sont les bienvenus dans les Issues GitHub.

NaviXav repose sur une double licence : les usages non commerciaux sont
...
un droit de changement de licence.
