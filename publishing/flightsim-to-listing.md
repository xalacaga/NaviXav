# Flightsim.to Publication Pack — NaviXav 1.4.15
...
The 1.4.15 build ships uncompressed and carries full publisher metadata, which
...
2. Run `NaviXav-Setup-1.4.15.exe`.
...
`NaviXav-1.4.15-FlightsimTo-Installer.zip`
...
`NaviXav-1.4.15-windows-x64-portable.zip`
...
- [ ] Paste the version 1.4.15 changelog.
