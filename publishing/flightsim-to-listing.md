# Flightsim.to Publication Pack — NaviXav 1.4.10
...
The 1.4.10 build ships uncompressed and carries full publisher metadata, which
...
2. Run `NaviXav-Setup-1.4.10.exe`.
...
`NaviXav-1.4.10-FlightsimTo-Installer.zip`
...
`NaviXav-1.4.10-windows-x64-portable.zip`
...
- [ ] Paste the version 1.4.10 changelog.
