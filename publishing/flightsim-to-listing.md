# Flightsim.to Publication Pack — NaviXav 1.4.16
...
The 1.4.16 build ships uncompressed and carries full publisher metadata, which
...
2. Run `NaviXav-Setup-1.4.16.exe`.
...
`NaviXav-1.4.16-FlightsimTo-Installer.zip`
...
`NaviXav-1.4.16-windows-x64-portable.zip`
...
- [ ] Paste the version 1.4.16 changelog.
