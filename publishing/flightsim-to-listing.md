# Flightsim.to Publication Pack — NaviXav 1.4.7
...
The 1.4.7 build ships uncompressed and carries full publisher metadata, which
...
`NaviXav-1.4.7-FlightsimTo-Installer.zip`
...
`NaviXav-1.4.7-windows-x64-portable.zip`
...
- [ ] Paste the version 1.4.7 changelog.
