# Flightsim.to Publication Pack — NaviXav 1.5.1
...
The 1.5.1 build ships uncompressed and carries full publisher metadata, which
...
`NaviXav-1.5.1-FlightsimTo-Installer.zip`
...
`NaviXav-1.5.1-windows-x64-portable.zip`
...
- [ ] Paste the version 1.5.1 changelog.
