# Flightsim.to Publication Pack — NaviXav 1.4.11
...
The 1.4.11 build ships uncompressed and carries full publisher metadata, which
...
2. Run `NaviXav-Setup-1.4.11.exe`.
...
`NaviXav-1.4.11-FlightsimTo-Installer.zip`
...
`NaviXav-1.4.11-windows-x64-portable.zip`
...
- [ ] Paste the version 1.4.11 changelog.
